<?php
//generated dynamic Person class
...
class Person extends BaseClass {
	...
	function add_pt($ele) {
		if (isset($ele) && $this->validate_type('enum', $ele)) {
			$this->pt[] = $ele;
			return true;
		}
	...
	public $phone;
	public $phone_prt = array(3,'class',4,'Person_PhoneNumber');
	function size_phone() {
	...
	function add_phone($ele) {
		if (!isset($ele) || !$this->validate_type('class', $ele)){
			if (is_object($ele))	$ele = 'object';
			if (is_array($ele))	$ele = 'array';
	...
	public $phone1;
	public $phone1_prt = array(3,'class',6,'Person_PhoneNumber1');
